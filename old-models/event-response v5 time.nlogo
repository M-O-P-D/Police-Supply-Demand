...
to setup
  ...
  ask n-of number-resources patches [ sprout-resources 1 [set shape "circle" set color grey set resource-status 0] ]

  ;read in the event data
  ;set event-data csv:from-file "input-data/synthetic_day_reports_no_header.csv"
  set event-data csv:from-file "input-data/synthetic_day_reports_fake_time_no_header.csv"
  ...
  set dt time:create "2000/01/01 0:00"
...
to assign-resources
  ...
  [
    ...
    ifelse count resources with [resource-status = 0] >= event-resource-amount
    [
    ...
    ;[
      ...
      let my-resources n-of event-resource-amount resources with [resource-status = 0]
...
to update-all-plots
  ...
  plot (count resources with [resource-status = 1] / number-resources ) * 100
